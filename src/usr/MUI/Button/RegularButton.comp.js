...
import { RegularButtonTypes } from './RegularButton.props';
...
/**
 * RegularButton is generated by Webcodesk. Replace this comment with a valuable description.
 */
...
RegularButton.propTypes = RegularButtonTypes;
...
RegularButton.defaultProps = {
  ...
  onInputTextChange: () => {
    console.info('RegularButton.onInputTextChange is not set');
  },
  onSubmit: () => {
    console.info('RegularButton.onSubmit is not set');
  }
};
