...
import { test5Types } from './test5.props';
...
/**
 * test5 is generated by Webcodesk. Replace this comment with a valuable description.
 */
...
test5.defaultProps = {
  ...
  onInputTextChange: () => {
    console.info('test5.onInputTextChange is not set');
  },
  onSubmit: () => {
    console.info('test5.onSubmit is not set');
  }
};
