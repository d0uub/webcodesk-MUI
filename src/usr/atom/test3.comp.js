...
import { test3Types } from './test3.props';
...
/**
 * test3 is generated by Webcodesk. Replace this comment with a valuable description.
 */
...
test3.defaultProps = {
  ...
  onInputTextChange: () => {
    console.info('test3.onInputTextChange is not set');
  },
  onSubmit: () => {
    console.info('test3.onSubmit is not set');
  }
};
